...
public class Application2 {
	...
	public int combinations(int n, int k) {
		// Fill your code here
        Application2 object = new Application2();
		return (object.factorial(n)/(object.factorial(k)*object.factorial(n-k)));
	...
	public static void main(String args[]) {
        ...
        Application2 ob = new Application2();
		...
		System.out.print("n= ");
		int b = in.nextInt();
		System.out.println("Factorial ("+b+") = "+ob.factorial(b));
		...
		System.out.print("k= ");
		int d = in.nextInt();
		System.out.println("Combinations("+c+","+d+") = "+ob.combinations(c,d));
		...
		System.out.println("Number of digits = "+ob.digitsOfInteger(e));
		...
		double apotelesma = ob.findArea(i,j,k);
		if (apotelesma == -1)
		...
		System.out.print("n= ");
		int l = in.nextInt();
		System.out.println("The reversed number is = "+ob.reverseDigits(l));
		...
		System.out.print("n= ");
		int m = in.nextInt();
		System.out.println("Min Digit = "+ob.minDigit(m));
