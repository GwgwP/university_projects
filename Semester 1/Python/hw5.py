...
class RomanClock(Clock):
    ...
    def __init__(self, h, m, s):
        ...
        self._m = RomanCascadeCounter(self._h, 60, m) #vazoume self._h giati ta lepta epireazoun tis wres
        self._s = RomanCascadeCounter(self._m, 60, s) #vazoume self._m giati ta seconds epireazoun ta lepta
...
class DayCounter(CyclicCounter):
    ...
    def __init__(self, day = 'Sunday'):
        CyclicCounter.__init__(self, 7, self._days.index(day)) #vazoume tin index giati theloume na doume se poia thesi tha vrisketai kathe fora i sygkekrimena mera
    
    def __str__(self):
        return '{0}'.format(self._days[self.value])
...
class DayClock(Clock):
    ...
    def __str__(self):
        return Clock.__str__(self) +' '+ '{0}'.format(self._d) 